                    ...
                    <div class="p-6 text-gray-900">
                        ...
                        <form method="POST" action="{{ route('categorias.update', $categoria) }}">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="name" id="name" value="{{ $categoria->name }}" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full px-3 py-2">
                            </div>
